...
def plot(df, 
    ...
    # Plot the scatters
    plt.scatter(cat_x, cat_y, marker='o', s=5, c='#FFFF00', alpha=0.5, edgecolors='k', label='sample')  # Only including the label on one of these so it is only marked once on the plot
    plt.scatter(an_x, an_y, marker='o', s=5, c='#FFFF00', alpha=0.5, edgecolors='k')
    plt.scatter(d_x, d_y, marker='o', s=5, c='#FFFF00', alpha=0.5, edgecolors='k')
